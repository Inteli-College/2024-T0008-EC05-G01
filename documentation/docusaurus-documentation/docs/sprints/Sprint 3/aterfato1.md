...
<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 03 - Conexão das saídas da placa a protoboard</p>
...
<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 04 - Conexão da protoboard inteira</p>
...
<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 05 - Montagem da Raspberry Pi Pico na protoboard</p>
...
<div style={{width: '70%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 06 - Exemplo de um LED e seus terminais</p>
...
<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 07 - Posicionamento do LED na protoboard</p>
...
<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 08 - Conexão entre o terminal negativo do LED e o resistor</p>
...
<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 09 - Conexão entre o terminal negativo do LED e o GND da protoboard</p>
...
<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 10 - Conexão do terminal positivo do LED a uma porta lógica da placa</p>
...
<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 11 - Conexão do terminal positivo do LED a uma porta lógica da placa parte 2</p>
...
<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 12 - Posicionamento do sensor na protoboard</p>
...
<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 13 - Posicionamento do resistor na protoboard</p>
...
<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 14 - Posicionamento do GND do sensor na protoboard</p>
...
<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 15 - Posicionamento do resistor na protoboard</p>
    ![image](/img/resistor-infra.jpeg)
    <p>Fonte: Elaboração própria</p>
</div>

<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 16 - Posicionamento do GND do sensor na protoboard</p>
    ![image](/img/conexao-infra-gnd.jpeg)
    <p>Fonte: Elaboração própria</p>
</div>
...
<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 17 - Posicionamento do sensor em uma porta lógica na placa</p>
    ![image](/img/conexao-pl-infra.jpeg)
    <p>Fonte: Elaboração própria</p>
</div>

<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 18 - Posicionamento final do sensor na protoboard</p>
...
<div style={{width: '50%', margin: '0 auto', textAlign: 'center'}}>
    <p>Imagem 19 - Montagem final do circuito</p>
